...
class ConsumerAnswerTests(unittest.TestCase):
    ...
    def test_builds_three_layer_html_and_optional_image(self):
        ...
        self.assertIn("EAL Evidence Analysis Manual（2022 年 11 月版）", page)
        self.assertIn("©2022 Evidence Analysis Manual Academy of Nutrition and Dietetics", page)
    ...
    def test_builds_quick_card_without_pubmed_bundle_and_marks_boundary(self):
        ...
        self.assertIn("https://www.andeal.org/evidence-analysis-manual", page)
