...
# These committed behavior cases intentionally preserve the pre-access-audit log shape so
# legacy compatibility remains tested. Production drafts use the complete HEADERS list and
# must not create new abstract_only records.
LEGACY_HEADERS = [
    header for header in HEADERS
    if header not in {"pmcid", "access_candidates", "full_text_access_attempts", "access_checked_at"}
]
